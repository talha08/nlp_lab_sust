                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="leadership-wrapper"><!-- leadership single wrap -->
                                        <figure class="leadership-photo">
                                            <br/>
                                            <img src="{!! asset($user->teachers->img_url)!!}" height="150" width="150"
                                                 alt="{!! $user->name !!}"/>
                                            <br/><br/>
                                        ...
                                        <div class="col-sm-offset-3 "><!-- accordion -->
                                                    ...
                                                    <div class="panel-collapse collapse in" id="collapseThree">
                                                        <div class="panel-body">
                                                            ...
                                                            @if($user->teachers->linkedIn_user != null)
                                                                <a href="{!! asset($user->teachers->linkedIn_user) !!}"
                                                                   target="_blank"><i
                                                                            class="fa fa-linkedin-square fa-2x"></i></a>
                                                            @endif
                                                            @if($user->teachers->academia != null)
                                                                <a href="{!! asset($user->teachers->academia) !!}"
                                                                   target="_blank"><i
                                                                            class="ai ai-academia-square ai-2x"></i></a>
                                                            @endif
                                                            @if($user->teachers->researchgate != null)
                                                                <a href="{!! asset($user->teachers->researchgate) !!}"
                                                                   target="_blank"><i
                                                                            class="ai ai-researchgate-square ai-2x"></i></a>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="panel panel-default"><!-- accordion panel three -->
                                                        ...
                                                        <div class="panel-body">
                                                            <p>
                                                                @foreach($projects as $pro)
                                                                    <a href="{!!  route('labfront.project_single',App\Project::where('id',$pro->project_id)->pluck('project_meta_data') ) !!}"
                                                ...
                                                <div class="panel panel-default"><!-- accordion panel four -->
                                                    <div class="panel-heading">
                                                        <h4 class="panel-title">
                                                            <a href="#collapseFive" data-parent="#accordion"
                                                               data-toggle="collapse"
                                                               class="accordion-toggle collapsed">
                                                                Publication
                                                            </a>
                                                        ...
                                                        <div class="panel-body">
                                                            <p>
                                                                @foreach($papers as $pro)
                                                                    <a href="{!!  route('labfront.paper_single',App\Paper::where('id',$pro->paper_id)->pluck('paper_meta_data') ) !!}"
                                                                       title="Click to view full profile...">
                            ...
                            <div class="row gutter"><!-- row -->
                                <div class="col-lg-12 col-md-12">
                                    <div class="leadership-wrapper"><!-- leadership single wrap -->
                                        <figure class="leadership-photo">
                                            <br/>
                                            <img src="{!! asset($user->otherUsers->img_url)!!}" height="150" width="150"
                                                 alt="{!! $user->name !!}"/>
                                            <br/><br/>
                                                    ...
                                                    <div class="panel-collapse collapse" id="collapseThree">
                                                        <div class="panel-body">
                                                            ...
                                                            @if($user->otherUsers->linkedIn_user != null)
                                                                <a href="{!! asset($user->otherUsers->linkedIn_user) !!}"
                                                                   target="_blank"><i
                                                                            class="fa fa-linkedin-square fa-3x"></i></a>
                                                            @endif
                                                            @if($user->otherUsers->github_user != null)
                                                                <a href="{!! asset($user->otherUsers->github_user) !!}"
                                                                   target="_blank"><i
                            ...
                            <div class="row gutter"><!-- row -->
                                <div class="col-lg-12 col-md-12">
                                    <div class="leadership-wrapper"><!-- leadership single wrap -->
                                        <figure class="leadership-photo">
                                            <br/>
                                            <img src="{!! asset($user->students->img_url)!!}" height="150" width="150"
                                                 alt="{!! $user->name !!}"/>
                                            <br/><br/>
                                                    ...
                                                    <div class="panel-collapse collapse" id="collapseThree">
                                                        <div class="panel-body">
                                                            ...
                                                            @if($user->students->linkedIn_user != null)
                                                                <a href="{!! asset($user->students->linkedIn_user) !!}"
                                                                   target="_blank"><i
                                                                            class="fa fa-linkedin-square fa-2x"></i></a>
                                                            @endif
                                                            @if($user->students->github_user != null)
                                                                <a href="{!! asset($user->students->github_user) !!}"
                                                                   target="_blank"><i
                    ...
                    <div class="col-padded col-shaded"><!-- inner custom column -->
                        <ul class="list-unstyled clear-margins"><!-- widgets -->
                            <li class="widget-container widget_nav_menu"><!-- widget -->
                                ...
                                <ul>
                                    <li><a href="{!! route('labfront.archive_blog') !!}" title="menu item">Blog
                                            Archive</a></li>
                                    <li><a href="{!! route('labfront.news') !!}" title="menu item">All News</a></li>
                                    <li><a href="{!! route('labfront.events') !!}" title="menu item">Upcoming Events</a>
                                    </li>
                                    <li><a href="{!! route('labfront.contact') !!}" title="menu item">Contact</a></li>
                                    <li><a href="{!! route('user.create') !!}" title="menu item">Apply for part of this
                                            Lab?</a></li>
                                </ul>
                            </li>
                                        ...
                                        <li class="recent-news-wrap news-no-summary">
                                            <div class="recent-news-content clearfix">
                                                <figure class="recent-news-thumb">
                                                    <a href="#"
                                                       title="{!! Str::limit($newsList->news_title,15) !!}"><img
                                                                src="{!! asset($newsList->news_image) !!}" width=100px"
                                                                height="100px"
                                                ...
                                                <div class="recent-news-text">
                                                    ...
                                                    <h4 class="title-median"><a
                                                                href="{!! route('labfront.full_news') !!}"
                                                                title="{!! Str::limit($newsList->news_title,15) !!}">
                                                            {!! $newsList->news_title !!}
                                                        </a></h4>
                                                </div>
                                            </div>
