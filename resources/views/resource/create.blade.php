						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="panel-body">
									...
									{!! Form::open(array('route' => 'resource.store',  'files' => true) ) !!}



									<div class="form-group">
										{!! Form::label('resource_type', 'Select Type* :', array('class' => 'col-md-2 control-label')) !!}
                                    ...
                                    <button type="button" class=" form-group btn btn-warning" onclick="virgin()" id="buttId" style="margin-bottom: 10px">
                                        Add Resource Link
                                    </button>
                                    <div id="resource">
