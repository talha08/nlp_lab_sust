...
$result = mysqli_query($conn,"SELECT english ,bangla, user_name,id FROM e2b where status = 'incorrect' ORDER BY ID ASC LIMIT $start_from, $results_per_page ;");
...
<br>
<input value="corpus_correction" name="from" hidden>
<br>
